...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://royalxcasinopakistan.pk/disclaimer',
  ...
  alternates: {
    canonical: 'https://royalxcasinopakistan.pk/disclaimer',
  },
  robots: {
    index: true,
    follow: true,
                ...
                <div className="bg-[#0A1029] rounded-xl p-6 border border-accent">
                  ...
                  <ul className="space-y-3 text-gray-300">
                    <li className="flex items-start">
                      ...
                      <span>Royal X Casino is a card game that may involve <strong>real money</strong> when played on certain platforms.</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-accent mr-2 font-bold">•</span>
