...
export const metadata: Metadata = {
  title: 'Contact Us - Royal X Casino | Get Help & Support',
  description: 'Contact Royal X Casino support team for help with the app, content, privacy policy, and more. We are here to assist you.',
  keywords: 'contact royal x casino, royal x casino support, royal x casino email, customer support, help royal x casino',
  openGraph: {
    title: 'Contact Us - Royal X Casino',
    description: 'Get in touch with Royal X Casino support team for any queries or assistance.',
    url: 'https://royalxcasinopakistan.pk/contact-us-royal-x-casino-pakistan',
  ...
  alternates: {
    canonical: 'https://royalxcasinopakistan.pk/contact-us-royal-x-casino-pakistan',
  },
  robots: {
    index: true,
    follow: true,
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="bg-secondary rounded-xl p-6 md:p-8 border-2 border-orange-200 overflow-hidden">
                ...
                <div className="flex justify-center w-full min-w-0 overflow-hidden px-4">
                  <a
                    href="mailto:support@royalxcasinopakistan.pk"
                    aria-label="Send email to Royal X Casino support"
                  ...
                  >
                    ...
                    <span className="break-all">support@royalxcasinopakistan.pk</span>
                  </a>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-secondary rounded-xl shadow-lg p-6 text-center hover:shadow-2xl transition-shadow duration-300">
              ...
              <Link href="/about-us-royal-x-casino-pakistan" className="text-accent hover:text-accent font-semibold">
                About Us →
              </Link>
            </div>
          </div>
