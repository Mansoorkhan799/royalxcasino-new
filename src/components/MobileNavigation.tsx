...
export default function MobileNavigation() {
  ...
  return (
    <div className="md:hidden">
      ...
      {/* Mobile Navigation Menu — rendered via portal so it escapes the header's glass effect */}
      {isOpen && (
        <MobileMenuPortal>
          <div
            className="fixed inset-0 z-[100] flex flex-col overflow-y-auto"
            style={{ background: '#0a1628', backdropFilter: 'none', WebkitBackdropFilter: 'none' }}
          >
            ...
            <nav className="flex flex-col gap-1 p-5" aria-label="Main">
              ...
              <Link href="/how-to-deposit-money-from-royal-x-casino" className={mobileNavClass(pathname, '/how-to-deposit-money-from-royal-x-casino')} onClick={closeMenu} aria-current={pathname === '/how-to-deposit-money-from-royal-x-casino' ? 'page' : undefined}>Deposit Guide</Link>
              <Link href="/how-to-withdraw-money-from-royal-x-casino" className={mobileNavClass(pathname, '/how-to-withdraw-money-from-royal-x-casino')} onClick={closeMenu} aria-current={pathname === '/how-to-withdraw-money-from-royal-x-casino' ? 'page' : undefined}>Withdraw Guide</Link>
