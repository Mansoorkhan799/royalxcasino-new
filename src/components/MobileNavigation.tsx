        ...
        <MobileMenuPortal>
          ...
          >
            ...
            <nav className="flex flex-col gap-1 p-5" aria-label="Main">
              ...
              <Link href="/how-to-deposit-money-on-royal-x-casino" className={mobileNavClass(pathname, '/how-to-deposit-money-on-royal-x-casino')} onClick={closeMenu} aria-current={pathname === '/how-to-deposit-money-on-royal-x-casino' ? 'page' : undefined}>Deposit Guide</Link>
