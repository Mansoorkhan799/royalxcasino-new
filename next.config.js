...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/deposit-money-in-card-rummy', destination: '/deposit-money-in-royal-x-casino', permanent: true },
      { source: '/withdraw-money-from-card-rummy', destination: '/withdraw-money-from-royal-x-casino', permanent: true },
